export const data = {
  en: {
    ...
    skills: {
      title: "Skills",
      subtitle: "Core development and design abilities",
      skillsList: [
        {
          name: "JavaScript (ES6+)",
          description:
            "Modern JavaScript and ES6+ features for creating dynamic and interactive web experiences.",
        },
        {
          name: "React.js & Redux",
          description:
        ...
        },
        {
          ...
          description:
            "Managing code efficiently with Git, GitHub, and modern CI/CD pipelines.",
        },
      ],
    },
  ...
  tr: {
    ...
    skills: {
      title: "Yetenekler",
      subtitle: "Temel geliştirme ve tasarım becerilerim",
      skillsList: [
        {
          name: "JavaScript (ES6+)",
          description:
            "Modern JavaScript sözdizimiyle dinamik, etkileşimli web arayüzleri geliştirme.",
        },
        {
          name: "React.js & Redux",
          description:
